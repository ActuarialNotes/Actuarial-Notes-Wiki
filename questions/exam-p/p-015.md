...
verification:
  ...
  content_hash: sha256:8f388ff05240311ba8ede8f353e3b0966ce0db9491167837f3aa2e63fa58035a
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-015.md
---
...
P[N_1 + N_2 = 7] &= \sum_{n=0}^{7} P[N_1 = n]\,P[N_2 = 7 - n] \\
                 &= \sum_{n=0}^{7} \frac{1}{2^{n+1}} \cdot \frac{1}{2^{8-n}} \\
                 &= \sum_{n=0}^{7} \frac{1}{2^9} \\
                 &= \frac{8}{2^9} \\
                 &= \frac{8}{512} \\
                 &= \frac{1}{64}
\end{align*}
