...
// The readiness card rides in the orientation-card row when the exam page
// carries the `exam-guides` div. Exams without one get a marker inserted
// directly under the "Learning Objectives" heading instead.

describe('hasExamGuidesMarker', () => {
  it('detects the orientation-card div', () => {
