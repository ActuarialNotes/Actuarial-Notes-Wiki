...
verification:
  ...
  content_hash: sha256:c74e8f15195a212ab25c818b8a8c53e20af6afa1058a2b67d8025d15d710898c
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-047.md
---
...
$$
\begin{align*}
E[Y] &= \sum_{n=1}^{\infty} 10,000(n-1) P(N=n) \\
     &= 10,000 \sum_{n=0}^{\infty} (n-1) \frac{1.5^n e^{-1.5}}{n!} - 10,000(-1)P(N=0)
\end{align*}
$$
