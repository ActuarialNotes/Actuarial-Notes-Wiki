...
verification:
  ...
  content_hash: sha256:9d99d179489bf42596851db1e0cd72c339bcff008593d590c60a49564bcadc7d
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-023.md
---
...
$$
\begin{align*}
P[1 \leq N \leq 4] &= \frac{1}{6} + \frac{1}{12} + \frac{1}{20} + \frac{1}{30} \\
                   &= \frac{10+5+3+2}{60} \\
                   &= \frac{20}{60}
\end{align*}
$$
...
$$
\begin{align*}
P[N \geq 1 \mid N \leq 4] &= \frac{20/60}{50/60} \\
                          &= \frac{20}{50} \\
                          &= \frac{2}{5}
\end{align*}
$$
