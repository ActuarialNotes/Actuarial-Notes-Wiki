...
verification:
  ...
  content_hash: sha256:52c088e80c392a950c99f0d23311b1f3ef1dcb6cd4c31a91b8d2672c8ceb40c5
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-082.md
---
...
$$
\begin{align*}
Var(Y \mid X=1) &= \left(\frac{5}{7}\right)\left(\frac{2}{7}\right) \\
                &= \frac{10}{49} \\
                &\approx 0.204
\end{align*}
$$
