...
verification:
  ...
  content_hash: sha256:3d639972e324196b40c58f49394b1ab193ac8228275cde85d3905eb16f6faa34
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-034.md
---
...
$$
\begin{align*}
1 = \int_{0}^{1} k(1-y)^4 dy &= -\frac{k}{5}(1-y)^5 \Big|_{0}^{1} \\
                             &= \frac{k}{5} \implies k=5
\end{align*}
$$
...
$$
\begin{align*}
P[V > 10,000] &= P[100,000Y > 10,000] \\
              &= P[Y > 0.1] \\
              &= \int_{0.1}^{1} 5(1-y)^4 dy \\
              &= -(1-y)^5 \Big|_{0.1}^{1} \\
              &= 0.9^5 \\
              &= 0.59049
\end{align*}
...
$$
\begin{align*}
P[V > 40,000] &= P[100,000Y > 40,000] \\
              &= P[Y > 0.4] \\
              &= \int_{0.4}^{1} 5(1-y)^4 dy \\
              &= -(1-y)^5 \Big|_{0.4}^{1} \\
              &= 0.6^5 \\
              &= 0.07776
\end{align*}
...
$$
\begin{align*}
P[V > 40,000 \mid V > 10,000] &= \frac{P[V > 40,000]}{P[V > 10,000]} \\
                              &= \frac{0.07776}{0.59049} \\
                              &\approx 0.1317
\end{align*}
$$
