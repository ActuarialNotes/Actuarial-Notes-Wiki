...
verification:
  ...
  content_hash: sha256:1986a9a70b6defa163eae31617848b62ad52308f5410b9c0e9ec14aa015e15a3
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-043.md
---
...
E[X] &= \int_{-2}^{0} x\left(\frac{-x}{10}\right)dx + \int_{0}^{4} x\left(\frac{x}{10}\right)dx \\
     ...
     &= \left( 0 - \frac{-(-8)}{30} \right) + \left( \frac{64}{30} - 0 \right) \\
