...
verification:
  ...
  content_hash: sha256:404289cb35b8a65a3d1d73f8a34db001d0850fb08839d02273bbdfa7e1858665
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-091.md
---
...
$$
\begin{align*}
P(\text{dies before 50} \mid \text{alive at 40}) &= P(T < 50 \mid T > 40) \\
                                                 &= \frac{P(40 < T < 50)}{P(T > 40)} \\
...
$$
\begin{align*}
1 - F(40) &= \exp\left(\frac{1 - 1.1^{40}}{1000}\right) \\
          &= \exp\left(\frac{1 - 45.259}{1000}\right) \\
          &= \exp(-0.044259) \\
          &\approx 0.9567
\end{align*}
$$
$$
\begin{align*}
1 - F(50) &= \exp\left(\frac{1 - 1.1^{50}}{1000}\right) \\
          &= \exp\left(\frac{1 - 117.39}{1000}\right) \\
          &= \exp(-0.11639) \\
          &\approx 0.8901
\end{align*}
$$
