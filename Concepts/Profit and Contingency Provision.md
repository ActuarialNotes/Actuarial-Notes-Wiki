**Profit and Contingency Provision** is the loading in the insurance rate structure that compensates the insurer for bearing underwriting risk and provides a margin for adverse deviation from expected losses and expenses.

- In the pure premium ratemaking formula, the provision enters as $Q$ in the permissible loss ratio: $\text{PLR} = 1 - V - \frac{F}{\bar{P}} - Q$, where $V$ is the variable expense ratio, $F/\bar{P}$ is the fixed expense ratio, and $Q$ is the profit and contingency provision
- The target combined ratio implied by the provision is $1 - Q$; for example, a $5\%$ profit provision targets a combined ratio of $95\%$
