...
- The $CV$ measures dispersion as a proportion of the mean, without dimension.
- $CV$ is used to compare the relative variability of distributions with different units or scales.
