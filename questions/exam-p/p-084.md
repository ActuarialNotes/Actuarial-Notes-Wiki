...
verification:
  ...
  content_hash: sha256:47e664f41843e0430264903f53c278e86440e5774334e8b35004312c2dfbe40d
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-084.md
---
...
$$
\begin{align*}
P(4 < S < 8 \mid N=1) &= \int_4^8 \frac{1}{5}e^{-s/5} ds \\
                      &= e^{-4/5} - e^{-8/5}
\end{align*}
$$
...
$$
\begin{align*}
P(4 < S < 8 \mid N>1) &= \int_4^8 \frac{1}{8}e^{-s/8} ds \\
                      &= e^{-4/8} - e^{-8/8} \\
                      &= e^{-1/2} - e^{-1}
\end{align*}
$$
...
P(4 < S < 8) &= 0\left(\frac{1}{2}\right) + (e^{-0.8} - e^{-1.6})\left(\frac{1}{3}\right) + (e^{-0.5} - e^{-1})\left(\frac{1}{6}\right) \\
             &= \frac{0.4493 - 0.2019}{3} + \frac{0.6065 - 0.3679}{6} \\
             &= \frac{0.2474}{3} + \frac{0.2386}{6} \\
             &= 0.0825 + 0.0398 \\
             &= 0.1223 \approx 0.12
\end{align*}
$$
