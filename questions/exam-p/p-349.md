...
verification:
  ...
  content_hash: sha256:017c2a8bb916b93013f9e00fbd128d1ec811499f7f778011c561ea870dafc086
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-349.md
---
...
$$
\begin{align*}
P(\text{pass both}) &= 0.70 \times \frac{10}{17} \\
                    &= \frac{7}{17} \\
                    &\approx \mathbf{0.412 \approx 0.41}
\end{align*}
$$
