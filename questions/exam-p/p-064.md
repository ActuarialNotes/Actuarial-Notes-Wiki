...
verification:
  ...
  content_hash: sha256:0f2ab6c6911ed794511995a5fe85e32a1777515b7dfb37d5cdee460e342487e4
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-064.md
---
...
$$
\begin{align*}
F(x) &= \int_{1}^{x} \frac{3}{t^4} dt \\
     &= \left[ -\frac{1}{t^3} \right]_1^x \\
     &= 1 - x^{-3}, \quad x > 1
\end{align*}
$$
...
$$
\begin{align*}
E[Y] &= \int_{1}^{\infty} y g(y) dy \\
     &= 9 \int_{1}^{\infty} (y^{-3} - 2y^{-6} + y^{-9}) dy \\
     &= 9 \left[ \frac{y^{-2}}{-2} - \frac{2y^{-5}}{-5} + \frac{y^{-8}}{-8} \right]_1^{\infty} \\
     &= 9 \left( 0 - \left( -\frac{1}{2} + \frac{2}{5} - \frac{1}{8} \right) \right) \\
     &= 9 \left( \frac{1}{2} - \frac{2}{5} + \frac{1}{8} \right) \\
     &= 9 \left( \frac{20 - 16 + 5}{40} \right) \\
     &= 9 \left( \frac{9}{40} \right) \\
     &= \frac{81}{40} \\
     &= 2.025
\end{align*}
$$
