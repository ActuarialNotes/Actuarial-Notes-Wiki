...
verification:
  ...
  content_hash: sha256:74e1153a9f09758e8a71c5530f3454b268b8ca108f2db8b6b8ffd7857bf9fe04
  sources: []
  open_findings: 0
  open_critical: 0
...
- **Proportional:** [[Quota Share]] cedes the same percentage of every policy; [[Surplus Share]] cedes a percentage that rises with the size of the risk. Either way the reinsurer pays a ceding commission for the cedant's acquisition and underwriting expenses. **Non-proportional:** [[Excess of Loss]] per risk (one large loss on one property), per occurrence (casualty occurrences, including high [[Clash Cover|clash]] layers, and property [[Catastrophe Loss|catastrophe]] events), and [[Aggregate Excess of Loss]] (stop loss, or an aggregate deductible on a layer).
...
- **Statements and reserves (Exams 6C, 7).** Proportional ceded premium, unearned premium and claims scale with gross and develop like gross. Excess cessions carry little premium but sit on large, late-reported claims, so ceded development is longer and more volatile — estimate gross and ceded separately ([[Reinsurance Reserving]]). In Canada, under [[IFRS 17]] every type is a [[Reinsurance Contracts Held|reinsurance contract held]], shown as a separate asset and never netted. A ceding commission that does not depend on claims reduces the premium paid to the reinsurer; commission that varies with claims (a sliding scale, a profit commission) counts as part of the expected recoveries. [[MCT]] capital credit depends on [[Registered Reinsurance|registered]] or [[Unregistered Reinsurance|unregistered]] status. An aggregate structure that fails [[Risk Transfer]] is [[Deposit Accounting|deposit-accounted]].
...
>
> > [!answer]-
> > 1. **Quota share.** It cedes premium and unearned premium, and the ceding commission recovers the acquisition cost already paid, so net premium falls and surplus rises: surplus relief and capacity. It does not change the *shape* of the net result, since net is $(1-a)$ times gross.
