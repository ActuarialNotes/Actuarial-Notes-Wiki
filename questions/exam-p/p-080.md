...
verification:
  ...
  content_hash: sha256:337ab1fd848beb3dfee42e0365fe205ce5963700ba2d9542007d75a7a69c24b0
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-080.md
---
...
$$
\begin{align*}
= Cov(X,X) + 1.2Cov(X,Y) + Cov(Y,X) + 1.2Cov(Y,Y) &= Var(X) + 2.2Cov(X,Y) + 1.2Var(Y) \\
                                                  &= 2.4 + 2.2(1.6) + 1.2(2.4) \\
                                                  &= 2.4 + 3.52 + 2.88 \\
                                                  &= 8.80
\end{align*}
