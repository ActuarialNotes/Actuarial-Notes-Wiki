**Regulatory reporting** is the communication of reserve estimates, supporting actuarial work, and financial results to insurance regulators in prescribed formats, governed by state insurance laws and actuarial standards of practice.

- Key deliverables: the **Annual Statement** (Schedule P — loss development triangles by line), the **Statement of Actuarial Opinion** (actuary's opinion on reserve adequacy), and the **Actuarial Report** (detailed support for the opinion); all must comply with ASOP 43
- The actuarial opinion must state whether reserves are "fairly stated" within a range of reasonable estimates and disclose any material uncertainties, adverse trends, or departures from standard methods
