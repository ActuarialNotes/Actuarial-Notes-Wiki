...
verification:
  ...
  content_hash: sha256:4b033152365cac56dacf36d7a2f4978cfb753fe9f7592b77aaee015025bcbb8d
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-286.md
---
...
$$
\begin{align*}
P(\text{one} > \text{twice other}) &= 2 \times \frac{1}{3} \\
                                   &= \mathbf{\frac{2}{3}}
\end{align*}
$$
