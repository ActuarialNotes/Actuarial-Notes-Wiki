...
verification:
  ...
  open_findings: 0
  open_critical: 0
  log: .verify/Concepts/History of Solvency Regulation.md
---

**The History of Solvency Regulation** in the U.S. traces how state oversight of insurers' financial strength moved from **fixed rules** — minimum capital, deposits, periodic examinations — to a **uniform, risk-focused system** built after the insolvencies of the 1980s, and then to the **own-risk** tools of the NAIC's Solvency Modernization Initiative after 2008.

> $$\begin{gathered}\text{To the 1980s: fixed capital minima, exams} \\ \Downarrow \\ \text{1989--2001: accreditation, RBC, codified SAP} \\ \Downarrow \\ \text{2008 on: ORSA, governance, group supervision}\end{gathered}$$
...
- **The constant design choice:** the U.S. system aims to minimise the number and impact of insolvencies, not to eliminate them.

> [!example]- From Diagnosis to Cure {Example}
> *Failed Promises* made four findings about state solvency regulation, and a fifth problem — capital minima blind to risk — was widely recognised. Name the reform that answered each.
>
> > [!answer]-
> > 1. **Filings were not being read** → systematic off-site analysis: IRIS and the FAST scoring tools to prioritise, a *Financial Analysis Handbook* for quarterly review, and NAIC peer review of nationally significant insurers.
> > 2. **Departments were understaffed** → accreditation standards requiring adequate resources and qualified staff, not just adequate laws.
> > 3. **No examination requirement** → an accreditation standard requiring a full-scope financial examination of every domestic insurer at least once every five years.
> > 4. **No interstate coordination** → other states may rely on an *accredited* domiciliary regulator, plus the lead-state concept and shared NAIC databases.
> > 5. **Flat capital minima** → RBC, sized to each insurer's asset, credit and underwriting risk, with a legislated intervention ladder.
> >
> > Together these kept solvency regulation with the states: the reforms were designed so that Congress would have no gap left to fill.
