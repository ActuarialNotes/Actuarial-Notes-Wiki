...
verification:
  ...
  content_hash: sha256:e15a34640a2b069445118bff90e3dcb88df9fb0e0f58cb02d8de8b9214d81551
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-036.md
---
...
$$
\begin{align*}
P[X < 2 \mid X \ge 1.5] &= \frac{P[1.5 \le X < 2]}{P[X \ge 1.5]} \\
                        &= \frac{F(2) - F(1.5)}{1 - F(1.5)} \\
                        &= \frac{(1 - 2^{-3}) - (1 - 1.5^{-3})}{1 - (1 - 1.5^{-3})} \\
                        &= \frac{-1/8 + (2/3)^3}{(2/3)^3} \\
                        &= \frac{8/27 - 1/8}{8/27} \\
                        &= \frac{37/216}{8/27} \\
                        &= \frac{37}{64} \\
                        &\approx 0.578
