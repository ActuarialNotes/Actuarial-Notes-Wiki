...
verification:
  ...
  content_hash: sha256:9266e9504b7d0a463ffabf90f74b35127ce2b1bc450134728cac8a9446f2b31c
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-040.md
---
...
$$
\begin{align*}
P(D > 0) &= P\left(Z > \frac{0 - (-1000)}{2828.43}\right) \\
         &= P(Z > 0.3535)
\end{align*}
$$
