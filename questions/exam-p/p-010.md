...
verification:
  ...
  content_hash: sha256:0ef8e2fe1c8b3d3cfdeb6c044982e2eb8722cc6486f98023a637a23faef0274c
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-010.md
---
...
$$
\begin{align*}
P[C^c \cap D^c] &= P[C^c]P[D^c] \\
                &= (1 - 2\sqrt{0.075})(1 - \sqrt{0.075}) \\
                &\approx 0.33
\end{align*}
$$
