...
verification:
  ...
  content_hash: sha256:8ba327ad43efd9db53371cbc5e1bf042c41b64f600ab0676cd9922f11b10096d
  sources: []
  open_findings: 0
  open_critical: 0
...
- **The P&C components:**
  ...
  - $R_3$ — credit risk: [[Reinsurance Credit Risk|reinsurance recoverables]] and other receivables.
  ...
  - $R_{\text{cat}}$ — [[Catastrophe Risk|catastrophe risk]]: modelled hurricane and earthquake losses; other perils, such as wildfire, have been reported for information while the NAIC evaluates them. Older texts show the formula without $R_{\text{cat}}$.
- **Covariance.** Adding the charges would assume every risk goes wrong at once; the square root treats $R_1$–$R_5$ and $R_{\text{cat}}$ as independent. An [[Operational Risk|operational risk]] add-on of $3\%$ of $\text{RBC}_{\text{cov}}$ follows, and ACL is **half** the total.
...
- **TAC** is [[Capital and Surplus|statutory surplus]], adjusted — chiefly by removing any non-tabular reserve discount and by affiliate adjustments; credit for capital and surplus notes is capped.
...
- **What it is not.** The NAIC says RBC is not meant to rank insurers: it is a floor that triggers legal authority, one tool of [[Solvency Monitoring]] alongside the [[IRIS Ratios]]. The great majority of insurers trigger no action level.
