---
Title: "Technical Notes for Automobile Insurance Rate and Risk Classification Filings"
Author: "Financial Services Commission of Ontario"
Year: "2016"
date: "2016"
Publisher: "Financial Services Commission of Ontario"
Type: "Technical Notes"
Available from: "[casact.org](https://www.casact.org/sites/default/files/2022-05/6C_FSCOTechNotes_102016.pdf)"
verification:
  status: unverified
  confidence: null
  last_checked: null
  ...
  open_findings: 0
  open_critical: 0
  log: .verify/Resources/Books/FSCO Tech Notes.md
---
![[FSCO Tech Notes - Cover.svg]]

The companion to [[FSCO Private Auto]]: what the regulator expects **technically** behind each item of an Ontario auto rate filing. Read for [[Exam 6C (CAS)|Exam 6C]] objective A1; the syllabus assigns **Sections A–F, pp. 1–14**.

## Structure

- **A. Introduction** · **B. Requirement to file** · **C. Filing documentation** · **D. Reviewing rate adequacy**
- **E. Major filings** — 23 numbered technical notes, keyed to the Section 4 items of the filing guidelines
- **F. Rate filing checklist for major filings**
- *Exhibit 1 — criteria for simplified filings*
...
These notes are where the Exam 5 ratemaking toolkit meets Canadian [[Rate Regulation|rate regulation]]: every standard technique — development, trend, on-levelling, credibility, profit provision — reappears here as something a regulator will test the support for. A common exam task is to say what a filing is missing, or why the regulator would reject a particular selection.

## Related readings
- [[FSCO Private Auto]] — the filing structure these notes support
- [[CIA Territories]] — territorial definitions and relativities
- [[FSRA Risk Management]] — the governance expected around a predictive model used in a filing

## Links
- [Technical Notes for Automobile Insurance Rate and Risk Classification Filings (CAS)](https://www.casact.org/sites/default/files/2022-05/6C_FSCOTechNotes_102016.pdf)
