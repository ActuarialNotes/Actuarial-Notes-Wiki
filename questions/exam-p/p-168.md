...
verification:
  ...
  content_hash: sha256:bfe9f04087cc463fcb755c604f78de5a781e1313de13eec2be87fb45ef16bd80
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-168.md
---
...
$$
\begin{align*}
P(100 < \bar{Y} < 110) &= P\!\left(\frac{100-109}{5.2} < Z < \frac{110-109}{5.2}\right) \\
                       &= P(-1.731 < Z < 0.192) \\
                       &= \Phi(0.192) - \Phi(-1.731) \\
                       &\approx 0.576 - 0.042 \\
                       &= \mathbf{0.534 \approx 0.53}
\end{align*}
$$
