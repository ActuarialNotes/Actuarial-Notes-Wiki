...
verification:
  ...
  content_hash: sha256:e873a44eca73b0de992a4e8f6bb08e3ad122498cd980910f9395d780505bd9f1
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-083.md
---
...
$$
\begin{align*}
E[Q \mid P=0] &= 0(12/25) + 1(6/25) + 2(5/25) + 3(2/25) \\
              &= \frac{6 + 10 + 6}{25} \\
              &= \frac{22}{25}
\end{align*}
$$
...
$$
\begin{align*}
E[Q^2 \mid P=0] &= 0^2(12/25) + 1^2(6/25) + 2^2(5/25) + 3^2(2/25) \\
                &= \frac{6 + 20 + 18}{25} \\
                &= \frac{44}{25}
\end{align*}
$$
...
$$
\begin{align*}
Var(Q \mid P=0) &= E[Q^2 \mid P=0] - (E[Q \mid P=0])^2 \\
                &= \frac{44}{25} - \left(\frac{22}{25}\right)^2 \\
                &= 1.76 - 0.7744 \\
                &= 0.9856 \approx 0.99
\end{align*}
$$
