...
Let $X$ denote the annual cost before the tax, and $Y$ denote the annual cost after the 20% tax.
We are given $Var(X) = 260$.
The new cost is $Y = X + 0.20X = 1.2X$.
The variance of $Y$ is:
$$Var(Y) = Var(1.2X) = (1.2)^2 Var(X) = 1.44(260) = 374.4$$
