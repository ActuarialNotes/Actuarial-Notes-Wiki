...
verification:
  ...
  content_hash: sha256:d36f6a4e45c32d21667741bac86d2b26667a51840297bb74b80a8541405492c0
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-017.md
---
...
$$
\begin{align*}
Y &= \frac{X_1 + X_2}{2} \sim N\!\left(0,\; \sqrt{\frac{0.0056^2 h^2 + 0.0044^2 h^2}{4}}\right) \\
  &= N(0,\; 0.00356h)
\end{align*}
$$
