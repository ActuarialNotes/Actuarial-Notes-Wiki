...
export function ExamReadinessCard({ examId, examLabel, syllabus, onSelectConcept }: ExamReadinessCardProps) {
  ...
  return (
    <>
      {/* The name is spelled out rather than left to the visible words: below
          400px they are gone and the ring is aria-hidden, so the button would
          otherwise have no accessible name at all on a small phone. */}
      <button
        type="button"
