...
verification:
  ...
  content_hash: sha256:08adc549e97ec26f70f74d689e0ae78495ea243ad64b1278f7862f665aca5ffd
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-022.md
---
...
P[Y|C] &= \frac{P[C|Y]P[Y]}{P[C|T]P[T] + P[C|Y]P[Y] + P[C|M]P[M] + P[C|S]P[S]} \\
       ...
       &= \frac{0.0128}{0.0120 + 0.0128 + 0.0180 + 0.0155} \\
       &= \frac{0.0128}{0.0583} \\
       &\approx 0.22
\end{align*}
$$
