...
verification:
  ...
  content_hash: sha256:289987f4597715bb9f1ac24fe41e41a6aac117c42b95d813170bcb7703ce09e8
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-072.md
---
...
$$
\begin{align*}
P(-0.25 \le \bar{X} \le 0.25) &= P\left(\frac{-0.25}{5/24} \le Z \le \frac{0.25}{5/24}\right) \\
                              &= P(-1.2 \le Z \le 1.2)
\end{align*}
$$
