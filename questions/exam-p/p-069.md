...
verification:
  ...
  content_hash: sha256:bd9c7ed7d357aba20c25c59f0dabb379ceef63695afa06dfde2f6efc7815ee5c
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-069.md
---
...
$$
\begin{align*}
\sigma_T^2 &= 100 \times 100 \\
           &= 10,000 \implies \sigma_T = 100
\end{align*}
$$
...
$$
\begin{align*}
P[T < 7100] &= P\left(Z < \frac{7100 - 7000}{100}\right) \\
            &= P(Z < 1)
\end{align*}
$$
