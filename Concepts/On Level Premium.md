...
- The parallelogram method handles mid-year rate changes by computing the area (proportion of annual earned premium) at each rate level within a given accident or calendar year

> [!example]- On-Level Factor with Two Rate Changes {Example}
> Current index $= 1.00$. A $+10\%$ change took effect $1/1/2023$ (index $= 0.909$ before; $1.00$ after). CY 2022 earned premium $= \$1{,}000{,}000$, all written before the change.
>
> > [!answer]-
> > Historical average rate level index for CY 2022 $= 0.909$ (entire year at pre-change rates).
> > $$\text{On-Level Factor} = 1.00 / 0.909 = 1.100$$
> > $$\text{On-Level Premium} = \$1{,}000{,}000 \times 1.10 = \$1{,}100{,}000$$
