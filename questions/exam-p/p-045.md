...
verification:
  ...
  content_hash: sha256:43705f41468716e469e15c8eb8bbc653a4ad8ad68bb71a6be4d794d4917fa01e
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-045.md
---
...
$$
\begin{align*}
\int_{0}^{1} 0.1e^{-t/10} dt &= -e^{-t/10} \Big|_{0}^{1} \\
                             &= 1 - e^{-0.1}
\end{align*}
$$
$$
\begin{align*}
\int_{1}^{3} 0.1e^{-t/10} dt &= -e^{-t/10} \Big|_{1}^{3} \\
                             &= e^{-0.1} - e^{-0.3}
\end{align*}
$$
...
$$
\begin{align*}
1000 = x(1 - 0.5(0.9048) - 0.5(0.7408)) &= x(1 - 0.4524 - 0.3704) \\
                                        &= x(0.1772)
\end{align*}
$$
