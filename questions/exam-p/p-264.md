...
verification:
  ...
  content_hash: sha256:6c4e11b773e44c7101e952f77a5a7b80565cbbd7167ed7e9c763aaaf700b69de
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-264.md
---
...
$$
\begin{align*}
P(\text{contribute}) &= 0.55(0.30) + 0.45(0.20) \\
                     &= 0.165+0.090 \\
                     &= 0.255
\end{align*}
$$
...
$$
\begin{align*}
P(\text{female} \mid \text{contribute}) &= \frac{0.45 \times 0.20}{0.255} \\
                                        &= \frac{0.090}{0.255} \\
                                        &\approx \mathbf{0.353 \approx 0.35}
\end{align*}
$$
