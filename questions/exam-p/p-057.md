...
verification:
  ...
  content_hash: sha256:8f18b62b553798bdbf3fb6ad7e6992f0c2be8ed334f8235dfbabeaa3adcd94d8
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-057.md
---
...
$$
\begin{align*}
E[Y] &= \int_{0}^{4} x f(x) dx + 4 P(X > 4) \\
     &= \int_{0}^{4} x(0.2) dx + 4(0.2) \\
     &= 0.1x^2 \Big|_{0}^{4} + 0.8 \\
     &= 1.6 + 0.8 \\
     &= 2.4
\end{align*}
$$
...
$$
\begin{align*}
E[Y^2] &= \int_{0}^{4} x^2 f(x) dx + 4^2 P(X > 4) \\
       &= \int_{0}^{4} x^2(0.2) dx + 16(0.2) \\
       &= \frac{0.2x^3}{3} \Big|_{0}^{4} + 3.2 \\
       &= \frac{0.2(64)}{3} + 3.2 \\
       &= 4.2667 + 3.2 \\
       &= 7.4667
\end{align*}
