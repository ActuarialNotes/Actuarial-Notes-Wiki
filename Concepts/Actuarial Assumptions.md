...
| ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [[Independent Events|Independence]]                | Individual risks are often model as independent (i.e. each risk has no causal impact on the other). However in reality, risks can be correlated.                                                                                                           |
| [[Law of Large Numbers|Law of Large Numbers (LLN)]]  | Given a sample of independent, identically distributed (I.I.D) values, the sample mean converges to the **true mean.**                                                                                                                                     |
