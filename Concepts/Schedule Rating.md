**Schedule Rating** is an individual risk pricing modification that adjusts the manual (class) rate by applying underwriter-assigned debits or credits based on specific, observable characteristics of the individual risk that are not captured by the classification system alone.

- Schedule rating factors are applied **before** experience rating; they reflect qualitative or physical attributes of the risk — such as management quality, safety programs, physical condition of premises, or loss control — rather than the insured's own loss history
- Most state regulations cap schedule modifications at $\pm 25\%$ of the manual rate, and underwriters must document the specific risk attributes that justify any debit or credit applied
