...
- Premium trend is less commonly applied than loss trend; its use requires judgment about whether mix changes are transient or persistent

> [!example]- Premium Trend Adjustment {Example}
> On-level earned premium $= \$5{,}000{,}000$. Average premium has been rising $3\%/\text{yr}$ due to increasing insured values. Trend period $= 2$ years.
>
> > [!answer]-
> > $$\text{Trended premium} = 5{,}000{,}000 \times 1.03^{2} = 5{,}000{,}000 \times 1.0609 = \$5{,}304{,}500$$
> > This trended denominator better represents the premium base for the future rating period.
