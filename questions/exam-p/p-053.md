...
verification:
  ...
  content_hash: sha256:c4000d74f7eddf6c93eb4773470ad425028a94f6b6719d883ba2ed4d336603fb
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-053.md
---
...
$$
\begin{align*}
E[Y] &= \int_{d}^{1000} (x-d) f(x) dx \\
     &= \int_{d}^{1000} (x-d) \frac{1}{1000} dx \\
     &= \frac{(x-d)^2}{2000} \Big|_{d}^{1000} \\
     &= \frac{(1000-d)^2}{2000}
\end{align*}
$$
