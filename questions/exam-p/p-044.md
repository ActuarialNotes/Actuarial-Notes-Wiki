...
verification:
  ...
  content_hash: sha256:4d66ef39c74a4a99b0bb6e8f46ebfdefdd78c21c9d7aa4da38f6871af73cb548
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-044.md
---
...
$$
\begin{align*}
\int_{0}^{2} \frac{2}{3}e^{-t/3} dt &= -2e^{-t/3} \Big|_{0}^{2} \\
                                    &= -2e^{-2/3} + 2
\end{align*}
$$
...
\int_{2}^{\infty} t \left(\frac{1}{3}e^{-t/3}\right) dt &= -te^{-t/3} \Big|_{2}^{\infty} + \int_{2}^{\infty} e^{-t/3} dt \\
                                                        &= (0 - (-2e^{-2/3})) + \left( -3e^{-t/3} \Big|_{2}^{\infty} \right) \\
                                                        &= 2e^{-2/3} + 3e^{-2/3}
\end{align*}
$$
