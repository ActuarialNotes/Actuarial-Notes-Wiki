...
verification:
  ...
  content_hash: sha256:b1a93a58fda2d2d0f3e3f0d6e06e5749ee5bbc59525ab9b9a7f46659ccff44e6
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-336.md
---
...
$$
\begin{align*}
E[(X-d)_+] &= \frac{(100-d)^2}{2 \times 100} \\
           &= \frac{(100-d)^2}{200} \\
           &= 32
\end{align*}
$$
