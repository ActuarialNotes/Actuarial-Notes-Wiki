...
verification:
  ...
  content_hash: sha256:b154f6d127cd09940b51ce0ba6fbd06f27709c0ecba93fe03654e4deec45270e
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-041.md
---
...
P[X \ge 4] &= \binom{7}{4}(0.4)^4(0.6)^3 + \binom{7}{5}(0.4)^5(0.6)^2 + \binom{7}{6}(0.4)^6(0.6)^1 + \binom{7}{7}(0.4)^7 \\
           ...
           &= 0.193536 + 0.077414 + 0.017203 + 0.001638 \\
           &= 0.289791 \approx 0.29
\end{align*}
$$
