...
verification:
  ...
  content_hash: sha256:430099978f06a2d602053b248787db67513488b465c0d52e0c579c09cd152917
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-081.md
---
...
$$
\begin{align*}
P(\text{Wife dies} \mid \text{Husband survives}) &= \frac{P(\text{Only husband survives})}{P(\text{Husband survives})} \\
                                                 &= \frac{0.01}{0.97} \\
                                                 &= \frac{1}{97}
\end{align*}
$$
