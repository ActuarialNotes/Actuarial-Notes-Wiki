...
verification:
  ...
  content_hash: sha256:84e1767004b497952946a2e2bff47dc219bc6da3bfee60990fd5e54299b3bee4
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-042.md
---
...
$$
\begin{align*}
E[Y] &= \sum_{k=1}^5 Y(k)P(k) \\
     &= 100\left(\frac{5}{15}\right) + 200\left(\frac{4}{15}\right) + 300\left(\frac{3}{15}\right) + 350\left(\frac{2}{15}\right) + 400\left(\frac{1}{15}\right) \\
     &= \frac{500 + 800 + 900 + 700 + 400}{15} \\
     &= \frac{3300}{15} \\
     &= 220
\end{align*}
$$
