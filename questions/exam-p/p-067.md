...
verification:
  ...
  content_hash: sha256:77cb3f1f55bf8b89b9000fe0555b093564d6bd723500926def597b9901b29d6b
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-067.md
---
...
$$
\begin{align*}
P(2450 \le S \le 2600) \approx P\left(\frac{2450 - 2500}{50} \le Z \le \frac{2600 - 2500}{50}\right) &= P(-1 \le Z \le 2) \\
                                                                                                     &= P(Z \le 2) - P(Z \le -1)
\end{align*}
$$
