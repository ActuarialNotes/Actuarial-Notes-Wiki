...
verification:
  ...
  content_hash: sha256:ab084cf5d63c261dec51917a6cee6c707f440253b168aa8d868066c56c3bff12
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-039.md
---
...
$$
\begin{align*}
P &= \binom{10}{9}(0.8)^9(0.2)^1 + \binom{10}{10}(0.8)^{10}(0.2)^0 \\
  &= 10(0.1342)(0.2) + 0.1074 \\
  &= 0.2684 + 0.1074 \\
  &= 0.3758
\end{align*}
$$
...
$$
\begin{align*}
P(\text{exactly 1}) &= \binom{2}{1} (P)^1 (1-P)^1 \\
                    &= 2(0.376)(1 - 0.376) \\
                    &= 2(0.376)(0.624) \\
                    &= 0.469
\end{align*}
