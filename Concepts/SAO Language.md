...
verification:
  ...
  content_hash: sha256:18a38a65cedcdd6c5783dc37937012e20e11fde1e19ad1200ddd897815597f3d
  sources: []
  open_findings: 0
  open_critical: 0
...
- **Identification** — who is opining: relationship to the company (employee or consultant), qualifications, date of appointment, and that the **board of directors** made the appointment. If the actuary was approved by the Academy's Casualty Practice Council or by the commissioner, the company attaches the approval letter each year and this paragraph refers to it.
...
- **Around it.** The [[American Academy of Actuaries]]' annual COPLFR practice note offers illustrative wording; the confidential numbers go in the [[Actuarial Opinion Summary]]. The Canadian [[Statement of Actuarial Opinion]] speaks of unqualified, qualified, adverse and denied opinions instead.
...
>
> > [!answer]-
> > - **Identification.** The CFO cannot appoint: it must be the board (or a committee reporting to it), and the paragraph must say so, give the date and state her qualifications.
> > - **Scope.** Missing the prescribed sentence (assumptions and methods, Exhibit A, the review-through date) and the data paragraph — who prepared the data, its testing for reasonableness and consistency, and reconciliation to Schedule P, Part 1.
...
> > - **Relevant Comments.** This is the generic risk list the instructions exclude; everything required is missing, starting with RMAD.
> >
...
> >
> > *RMAD, drafted:* "The materiality standard I have used is \$30 million, 10% of the Company's statutory surplus, a level relevant to the regulators who rely on this opinion. I believe there are significant risks and uncertainties that could result in material adverse deviation in the Company's reserves. The principal risk is its concentration in long-haul trucking liability, where severity on recent accident years has been rising faster than assumed."
