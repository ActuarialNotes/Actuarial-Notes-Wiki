...
verification:
  ...
  content_hash: sha256:9c617bd5ea54f517159b91cd8adb8e2f302c148441a5ab43723283896a3bd2f9
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-050.md
---
...
E[X \wedge 10] &= \int_{1}^{10} y \left(\frac{2}{y^3}\right) dy + 10 P[Y > 10] \\
               ...
               &= \left( -\frac{2}{10} - (-2) \right) + 10 \left( 0 - (-(10)^{-2}) \right) \\
               &= (-0.2 + 2) + 10(0.01) \\
               &= 1.8 + 0.1 \\
               &= 1.9
\end{align*}
