---
Title: "Landmark Legal Insurance Cases in Canada"
Type: "Case Compilation"
...
verification:
  ...
  open_findings: 0
  open_critical: 0
  log: .verify/Resources/Books/Landmark Legal.md
---
![[Landmark Legal - Cover.svg]]

The compilation of Canadian insurance decisions on the [[Exam 6C (CAS)|Exam 6C]] syllabus, read for objective A2 — the issues, outcomes, rationale and implications of [[Court Case|court decisions]] for the insurance industry. This is the single most heavily examined reading in Domain A.
...
- **Good faith and its price** — *Whiten* made bad faith an independent wrong carrying punitive damages, which is why claims-handling practice is an insurance-law topic and not only an operational one.
- **Duty to defend versus duty to indemnify** — *Nichols*: the pleadings govern, so the defence obligation can exist for a claim that would never be covered.
- **Coverage triggers** — *Amos* (auto), *Alie* (long-tail construction), *Precision Plating* (exclusions).
- **Injury definitions drive reserves** — *Kusnierz*, *Pastore* and *Saadati* each widened who qualifies for a higher benefit tier, and each moved [[Statutory Accident Benefits|accident benefit]] costs.
- **Limitation and discoverability** — *Tomec*: a limitation period that has run on paper may not have run in law.

## Related readings
- [[Baer and Rendall]] — the casebook covering *Glenn*, *Fletcher* and *Dillon*
- [[McDonald]] — insurance law in the common-law provinces
- [[Davidson]] — the cap on non-pecuniary damages the *Morrow* challenge concerned

## Links
- [Two-Year Limitation Period to Dispute Denial of Accident Benefits is Subject to Discoverability (Kelly Santini LLP, 2019)](https://www.kellysantini.com/articles/two-year-limitation-period-dispute-denial-accident-benefits-subject-discoverability)
- [No More than What they Bargained For: Ontario Court of Appeal rejects All Sums Approach to Defence Costs (Roberton, 2024)](https://coxandpalmerlaw.com/publication/no-more-than-what-they-bargained-for-ontario-court-of-appeal-rejects-all-sums-approach-to-defence-costs/)
