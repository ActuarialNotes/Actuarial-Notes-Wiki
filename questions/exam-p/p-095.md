...
verification:
  ...
  content_hash: sha256:0dea15fd16f57581b85442b7b5bc68f056ffb76197a1e98f572b9e7ee5ce773a
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-095.md
---
...
E[N \mid L < 1] &= \frac{0 \cdot P(N=0, L<1) + 1 \cdot P(N=1, L<1) + 2 \cdot P(N=2, L<1)}{P[L < 1]} \\
                &= \frac{0 + 1(0.42) + 2(0.045)}{0.955} \\
                &= \frac{0.42 + 0.09}{0.955} \\
                &= \frac{0.51}{0.955} \\
                &\approx 0.534
\end{align*}
$$
