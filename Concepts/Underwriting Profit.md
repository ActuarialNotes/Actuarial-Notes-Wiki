**Underwriting Profit** is the insurer's income from insurance operations alone, equal to earned premium minus incurred losses, LAE, and underwriting expenses, before any credit for investment income.

- Underwriting profit margin $= \text{Earned Premium} - \text{Losses} - \text{LAE} - \text{Expenses}$, expressed as a ratio to earned premium; equivalently, underwriting profit margin $= 1 - \text{Combined Ratio}$
- A combined ratio above $100\%$ signals an underwriting loss, but the insurer may still be profitable overall if investment income on loss reserves and surplus exceeds the underwriting deficit — this is more likely for long-tail lines with large reserve balances
