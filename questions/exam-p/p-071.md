...
verification:
  ...
  content_hash: sha256:30f959627e5827db7772be8da339d7284a8b7995149d5c5df0b7fd81d848cf05
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-071.md
---
...
$$
\begin{align*}
P(S < 90.5) &= P\left(Z < \frac{90.5 - 70}{9}\right) \\
            &= P(Z < 2.278)
\end{align*}
$$
