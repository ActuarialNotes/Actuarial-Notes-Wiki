...
verification:
  ...
  content_hash: sha256:f327cd2264407349eaae8b13465adf6e333cdc920f0ba971091f6160adfd83c2
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-124.md
---
...
P(X < 4) &= P(X=0) + P(X=1) + P(X=2) + P(X=3) \\
         ...
         &= e^{-6} \left( 1 + 6 + \frac{36}{2} + \frac{216}{6} \right) \\
         &= e^{-6} (1 + 6 + 18 + 36) \\
         &= 61e^{-6} \\
         &\approx 0.1512
\end{align*}
