...
verification:
  ...
  content_hash: sha256:05191c9505a744f3a3debbbd9ca5ce2c286a9388f292a26b0f28848adba839fb
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-027.md
---
...
$$
\begin{align*}
P[C|I] &= \frac{P[I|C]P[C]}{P[I|C]P[C] + P[I|C^c]P[C^c]} \\
       &= \frac{(0.141)(1/5)}{(0.141)(1/5) + (0.334)(4/5)} \\
       &= \frac{0.0282}{0.0282 + 0.2672} \\
       &= \frac{0.0282}{0.2954} \\
       &\approx 0.096 \approx 0.10
\end{align*}
$$
