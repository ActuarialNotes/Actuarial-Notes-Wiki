...
verification:
  ...
  content_hash: sha256:7c55d479daee3fe2f66b846ae225d09395663e2749fb0a4496769e410368a7b8
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-066.md
---
...
$$
\begin{align*}
P(\bar{X} > 20,000) &= P\left(Z > \frac{20,000 - 19,400}{1000}\right) \\
                    &= P(Z > 0.6)
\end{align*}
$$
