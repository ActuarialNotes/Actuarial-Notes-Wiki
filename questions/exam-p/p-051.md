...
verification:
  ...
  content_hash: sha256:229d746b7895462efbea6985a74fc107f9eda8172ee65cb151e2391c56cc1529
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-051.md
---
...
\int_{1}^{15} (x-1) e^{-x/2} dx &= -2(x-1)e^{-x/2} \Big|_{1}^{15} + 2 \int_{1}^{15} e^{-x/2} dx \\
                                &= -28e^{-7.5} - 4e^{-x/2} \Big|_{1}^{15} \\
                                &= -28e^{-7.5} - 4e^{-7.5} + 4e^{-0.5} \\
                                &= 4e^{-0.5} - 32e^{-7.5} \\
                                &\approx 2.408
\end{align*}
$$
$$
\begin{align*}
E[\text{Payment}] &= 0.28 + (0.020012)(2.408) \\
                  &\approx 0.328 \text{ thousands} \\
                  &= 328
\end{align*}
$$
