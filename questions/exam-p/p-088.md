...
verification:
  ...
  content_hash: sha256:7c4953b4c04eec7541655074fa297cf3b5b32f0a1d27fb445b9759924c97c0ea
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-088.md
---
...
$$
\begin{align*}
G(115) &= P(X \le 150 \mid X > 20) \\
       &= \frac{P(20 < X \le 150)}{P(X > 20)} \\
       &= \frac{F(150) - F(20)}{1 - F(20)} \\
       &= \frac{(1 - e^{-1.5}) - (1 - e^{-0.2})}{e^{-0.2}} \\
       &= \frac{e^{-0.2} - e^{-1.5}}{e^{-0.2}} \\
       &= 1 - e^{-1.3} \\
       &= 1 - 0.27253 \\
       &= 0.72747
\end{align*}
