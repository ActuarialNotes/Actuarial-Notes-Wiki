...
- When data volume is insufficient for full credibility, the final indication is credibility-weighted: $Z \times \text{Indicated} + (1-Z) \times \text{Complement}$

> [!example]- Loss Ratio Indication with Credibility {Example}
> Projected loss ratio $= 72\%$, permissible loss ratio $= 65\%$, credibility $Z = 0.75$, complement (industry) $= +3\%$.
>
> > [!answer]-
> > $$\text{Indicated change} = (72\% / 65\%) - 1 = 10.8\%$$
> > $$\text{Final change} = 0.75(10.8\%) + 0.25(3\%) = 8.85\%$$
