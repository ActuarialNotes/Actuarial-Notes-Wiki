...
verification:
  ...
  content_hash: sha256:ccc020f00380bff7f7772db9147167601b25450d2c3d891ff1f8e1200b8aca34
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-048.md
---
...
E[X \wedge 2] &= \int_{0.6}^{2} x f(x) dx + \int_{2}^{\infty} 2 f(x) dx \\
              ...
              &= \frac{2.5}{1.5}(0.6) - \frac{2.5}{1.5}(0.6)^{2.5}(2^{-1.5}) + 2(0.6)^{2.5}(2^{-2.5}) \\
              &\approx 0.9343
\end{align*}
$$
