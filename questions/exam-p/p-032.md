...
verification:
  ...
  content_hash: sha256:17ea918f971e4877fc69fae2166eab48f27628ea520ef6ef8d1a9797de7526b1
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-032.md
---
...
$$
\begin{align*}
P[X > x] &= \int_{x}^{20} 0.005(20-t)dt \\
         &= 0.005\left(20t - \frac{1}{2}t^2\right) \Big|_{x}^{20} \\
         &= 0.005\left(400 - 200 - 20x + \frac{1}{2}x^2\right) \\
         &= 0.005\left(200 - 20x + \frac{1}{2}x^2\right)
\end{align*}
$$
