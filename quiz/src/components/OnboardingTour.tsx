...
const BASE_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: 'Concepts are the coloured links. Tap “Calculus” to open its explanation in a popup.',
    path: EXAM_P_ROUTE,
    match: onExam,
  ...
  },
  {
    ...
    body: 'Tap the play button next to the concept name to see what you can do with it.',
    match: onExam,
  ...
  },
  {
    ...
    body: 'Tap “view” to jump straight to your flashcard deck.',
    match: onExam,
  ...
  {
    icon: Layers,
    title: 'Your flashcards live here',
    body: 'Everything you save shows up on this page. Review your saved concepts anytime.',
    path: '/flashcards',
  ...
  },
  {
    ...
    body: 'Practise real exam-style questions and get instant, fully worked solutions.',
    path: '/',
    advance: 'manual',
  },
  {
