...
verification:
  ...
  content_hash: sha256:b059585d27b2f20bbd1e8e948760119fb4eab723ff4f03e1587c789092b795cd
  sources: []
  open_findings: 0
  open_critical: 0
  log: .verify/questions/exam-p/p-033.md
---
...
$$
\begin{align*}
1 = \int_{0}^{40} C(10+x)^{-2} dx &= -C(10+x)^{-1} \Big|_{0}^{40} \\
                                  &= \frac{C}{10} - \frac{C}{50} \\
                                  &= \frac{2C}{25}
\end{align*}
$$
...
$$
\begin{align*}
P[X < 6] &= \int_{0}^{6} 12.5(10+x)^{-2} dx \\
         &= -12.5(10+x)^{-1} \Big|_{0}^{6} \\
         &= 12.5\left(\frac{1}{10} - \frac{1}{16}\right) \\
         &= 12.5\left(\frac{6}{160}\right) \\
         &= 0.46875 \approx 0.47
\end{align*}
$$
