...
verification:
  ...
  content_hash: sha256:b9cc6a80a10a4e60b8ec0ee68aa2cea0029ba6270a77bd2e52488c8daf821a67
  sources: []
  open_findings: 0
  log: .verify/questions/exam-p/p-054.md
---
...
$$
\begin{align*}
F(x) &= \int_{200}^{x} \frac{2.5(200)^{2.5}}{t^{3.5}} dt \\
     &= \left[ -\frac{(200)^{2.5}}{t^{2.5}} \right]_{200}^{x} \\
     &= 1 - \left(\frac{200}{x}\right)^{2.5}
\end{align*}
$$
...
$$
\begin{align*}
x_{0.7} &= \frac{200}{(1-0.7)^{0.4}} \\
        &= \frac{200}{0.3^{0.4}} \\
        &\approx \frac{200}{0.6178} \\
        &\approx 323.73
\end{align*}
$$
$$
\begin{align*}
x_{0.3} &= \frac{200}{(1-0.3)^{0.4}} \\
        &= \frac{200}{0.7^{0.4}} \\
        &\approx \frac{200}{0.8671} \\
        &\approx 230.66
\end{align*}
$$
